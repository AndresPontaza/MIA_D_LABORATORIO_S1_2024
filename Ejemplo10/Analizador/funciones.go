...
func Analizar() {
	fmt.Println("Bienvenido al API del Sistema de Archivos")

	mux := http.NewServeMux()

	// Endpoint ṔOST para analizar comandos
...
// Separa por saltos de linea y luego realiza la separacion de los comandos
